    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link to={`/category/${CATEGORIES.PROBABILITY}`} className="p-6 bg-blue-100 dark:bg-blue-900/30 dark:text-blue-300 rounded-lg text-center hover:bg-blue-200 dark:hover:bg-blue-900/50 transition-colors">
            <h3 className="text-xl font-semibold">Probability & Statistics</h3>
          </Link>
          <Link to={`/category/${CATEGORIES.CALCULUS}`} className="p-6 bg-green-100 dark:bg-green-900/30 dark:text-green-300 rounded-lg text-center hover:bg-green-200 dark:hover:bg-green-900/50 transition-colors">
            <h3 className="text-xl font-semibold">Calculus</h3>
          </Link>
          <Link to={`/category/${CATEGORIES.PHYSICS}`} className="p-6 bg-red-100 dark:bg-red-900/30 dark:text-red-300 rounded-lg text-center hover:bg-red-200 dark:hover:bg-red-900/50 transition-colors">
            <h3 className="text-xl font-semibold">Physics</h3>
          </Link>
          <Link to={`/category/${CATEGORIES.ENGINEERING}`} className="p-6 bg-yellow-100 dark:bg-yellow-900/30 dark:text-yellow-300 rounded-lg text-center hover:bg-yellow-200 dark:hover:bg-yellow-900/50 transition-colors">
            <h3 className="text-xl font-semibold">Engineering</h3>
          </Link>
        </div>
      </div>

      <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg border dark:border-gray-700 mb-12 transition-colors">
        <h2 className="text-2xl font-bold mb-4">Why SciVizHub?</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-4">
            <div className="bg-primary-100 dark:bg-primary-600/20 text-primary-700 dark:text-primary-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
