          ...
          <div className="info-grid">
            <div className="info-card">
              ...
              <p>
                ...
                (reducing <InlineMath>{"\\Delta x"}</InlineMath>), the secant line approaches the tangent line. This is the key insight of calculus:
                the derivative is defined as the limit of the secant line slope as <InlineMath>{"\\Delta x"}</InlineMath> approaches zero.
              </p>

              <div className="math-formula">
                <BlockMath>{`\\text{Secant slope} = \\frac{f(x+\\Delta x) - f(x)}{\\Delta x}`}</BlockMath>
              </div>
              <div className="math-formula">
                <BlockMath>{`\\text{Tangent slope} = \\lim_{\\Delta x \\to 0} \\frac{f(x+\\Delta x) - f(x)}{\\Delta x}`}</BlockMath>
              </div>
            </div>
          ...
          <div className="info-card full-width">
            ...
            <div className="formula-grid">
              <div className="formula-column">
                <div className="math-formula">
                  <BlockMath>{`\\frac{d}{dx}(x^n) = nx^{n-1}`}</BlockMath>
                </div>
                <div className="math-formula">
                  <BlockMath>{`\\frac{d}{dx}(e^x) = e^x`}</BlockMath>
                </div>
                <div className="math-formula">
                  <BlockMath>{`\\frac{d}{dx}(\\ln(x)) = \\frac{1}{x}`}</BlockMath>
                </div>
                <div className="math-formula">
                  <BlockMath>{`\\frac{d}{dx}(\\sin(x)) = \\cos(x)`}</BlockMath>
                </div>
              </div>
              <div className="formula-column">
                <div className="math-formula">
                  <BlockMath>{`\\frac{d}{dx}(\\cos(x)) = -\\sin(x)`}</BlockMath>
                </div>
                <div className="math-formula">
                  <BlockMath>{`\\frac{d}{dx}(\\tan(x)) = \\sec^2(x)`}</BlockMath>
                </div>
                <div className="math-formula">
                  <BlockMath>{`\\frac{d}{dx}(\\sqrt{x}) = \\frac{1}{2\\sqrt{x}}`}</BlockMath>
                </div>
                <div className="math-formula">
                  <BlockMath>{`\\frac{d}{dx}\\left(\\frac{1}{x}\\right) = -\\frac{1}{x^2}`}</BlockMath>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="info-card full-width">
            ...
            <div className="insight-grid">
              <div className="insight-item">
                ...
                <p>
                  When <InlineMath>{"f'(x) > 0"}</InlineMath>, the function is increasing.
                  When <InlineMath>{"f'(x) < 0"}</InlineMath>, the function is decreasing.
                </p>
              </div>
              ...
              <div className="insight-item">
                <h4>Concavity</h4>
                <p>
                  The second derivative <InlineMath>{"f''(x)"}</InlineMath> tells us about concavity.
                  When <InlineMath>{"f''(x) > 0"}</InlineMath>, the curve is concave up (cup-shaped).
                  When <InlineMath>{"f''(x) < 0"}</InlineMath>, the curve is concave down (cap-shaped).
                </p>
              </div>
            </div>
