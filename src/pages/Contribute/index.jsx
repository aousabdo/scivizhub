...
const ContributePage = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto mb-8 text-center text-gray-700 dark:text-gray-300">
        <p>
      ...
      <div className="max-w-3xl mx-auto bg-gray-50 dark:bg-gray-800 border dark:border-gray-700 rounded-lg p-6 text-center">
