...
const VisualizationCard = ({ visualization, detailed = false }) => {
  ...
  return (
    <div className="border dark:border-gray-700 rounded-lg overflow-hidden shadow-lg dark:shadow-gray-900/50 transition-transform hover:scale-105 bg-white dark:bg-gray-800">
